...
app.set('views', path.join("".concat(__dirname, "/"), 'views'));
...
app.use(express["static"](path.join("".concat(__dirname, "/.."), 'client/dist')));
...
require('./routes')["default"](app); // catch 404 and forward to error handler
